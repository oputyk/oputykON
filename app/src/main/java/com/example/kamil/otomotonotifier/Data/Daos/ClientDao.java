...
public interface ClientDao {
    ...
    @Query("select * from client inner join searcherEntity on searcherEntity.phoneNumber = client.phoneNumber inner join adEntity on adEntity.searcherId = searcherEntity.id where adEntity.id = :adEntityId")
